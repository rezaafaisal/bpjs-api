                ...
                <form action="{{ route('check') }}" method="POST" class="w-7/12 mx-auto mt-10">
                    ...
                    <label class="block mb-4">
                        ...
                        <input name="nik" type="text"
                            class="p-2 focus:outline-none focus:ring-2 focus:ring-purple/20 rounded border w-full"
                    ...
                    <label class="block mb-6">
                        ...
                        <div class="relative" x-data="{show: false}">
                            <input name="password" :type="show? 'text':'password'"
                                class="block p-2 focus:outline-none focus:ring-2 focus:ring-purple/20 duration-150 rounded border w-full"
                                placeholder="Masukkan Password Anda">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                                <i @click="show = !show" :class="show?'fa-eye-slash':'fa-eye'"
                                    class="fas cursor-pointer text-lg duration-150 text-purple"></i>
                            </div>
                        </div>
                    </label>
                    {{-- <div class="relative" x-data="{show: false}">
                    ...
                    <button
                        class="py-2 bg-purple text-white font-medium w-full rounded hover:bg-purple/70 duration-150">Masuk</button>
                </form>
            </div>
